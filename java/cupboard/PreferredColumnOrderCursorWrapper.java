 ...
 * This cursor is passed to {@link cupboard.convert.EntityConverter#fromCursor(Cursor)} so that the converter does not have to do any look up from column to translation:
 * it can just assume that the column at a certain index is the same as returned from {@link cupboard.convert.EntityConverter#getColumns()} at the same index.
 */
