...
/**
 * Builder that can be used to build {@link cupboard.annotation.Index} annotations. This is useful for custom {@link cupboard.convert.EntityConverter}s
 * to specify their column indices in a {@link cupboard.convert.EntityConverter.Column}. For example {@link cupboard.convert.ReflectiveEntityConverter} will only process annotations when
 * {@link cupboard.Cupboard#isUseAnnotations()} is <code>true</code>. By overriding {@link cupboard.convert.ReflectiveEntityConverter#getIndexes(java.lang.reflect.Field)}
...
public class IndexBuilder {
     ...
     * @return a {@link cupboard.convert.IndexBuilder.CompositeIndexBuilder} for chaining
     */
