    ...
    public static class Builder {
        ...
        class IndexColumnMetadata implements Comparable<IndexColumnMetadata> {
            ...
            public boolean equals(Object obj) {
                ...
                if (mColumnName == null) {
                    if (other.mColumnName != null) return false;
                } else if (!mColumnName.equals(other.mColumnName)) return false;
                return true;
            }
            ...
            public int hashCode() {
                final int prime = 31;
                int result = 1;
                result = prime * result + ((mColumnName == null) ? 0 : mColumnName.hashCode());
                return result;
            }
        }
    }
